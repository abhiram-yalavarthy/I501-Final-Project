...
if visualization_type == 'Time Series Plot':
    ...
    st.write("Autocorrelation is the correlation between two observations at different points in a time series.")
    st.pyplot()
    ...
    st.write("The partial autocorrelation function (PACF) gives the partial correlation of a stationary time series with its own lagged values, regressed the values of the time series")
    st.pyplot()
...
from table import print_commodity_units
